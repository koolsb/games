...
return [
    ...
    */
    ...
    'component_namespaces' => [
        'shell' => resource_path('views/shell'),
        'phase10' => resource_path('views/phase10'),
    ],
    ...
    | an entire page via `Route::livewire('/phase10', 'phase10::generator')`.
    | In this case, the component's content renders into $slot.
    |
    */

    'component_layout' => 'shell::app',
