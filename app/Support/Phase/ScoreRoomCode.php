...
/**
 * The 4-character code players read out to each other to open a scoring
 * game's read-only view. Base32 (RFC 4648) minus I and O, which people
 * mistype as 1 and 0 — the alphabet already has no 0 or 1, so dropping the
 * lookalikes costs two symbols and buys codes that survive being shouted
 * across a table.
 */
final class ScoreRoomCode
{
